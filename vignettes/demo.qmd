...
- In J PERP, RStudio is commonly used for analysis. 
...
2. Create a new .qmd file.
    ...
    - On console, run `jprep.datasets::create_qmd("path/to/new_file.qmd")`
      - This function opens a new .qmd file containing commonly used yaml.
...
- [TokyoR#108_NestedDataHandling](https://speakerdeck.com/kilometer/tokyor-number-108-nesteddatahandling)
...
tables <-
  ...
  mutate(
    ...
    section_gt = "#### gt::gt()",
    section_gt_interactive = "#### gt::gt() |> gt::opt_interactive() (and run in a separate chunk)",
    section_tt = "#### tinytable::tt()",
    section_flex = "#### flextable::flextable() |> knitr::knit_print() (using map_chr())",
    section_DT = "#### DT::datatable() |> htmltools::div() (and run in a separate chunk)",
    section_reac = "#### reactable::reactable() |> htmltools::div() (and run in a separate chunk)"
  )
