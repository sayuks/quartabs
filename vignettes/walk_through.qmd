...
# Using cat() results in output as a number.
# This is not usually the expected output.
cat(test_factor)
cat(test_date)
cat(test_posixct)

# Therefore, render_tabset() uses cat()
# after converting it internally to a string.
